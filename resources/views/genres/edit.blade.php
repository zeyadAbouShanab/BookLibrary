...
<div class="card bg-dark text-white">
            <h3 class="display-8" style="text-align:center;">Edit Genre</h3>
        </div>
<form style="background-color:#E6E6FA;font-size:20px;font-weight:bold;padding-left:20px" action="{{ route('genres.update', $genre->id) }}" method="POST">
    ...
    <br>
    <div class="form-group">
    <p style="text-align:center;"><button type="submit" style="width:200px" class="btn btn-primary">Update genre</button></p>
    </div>
