...
<div class="card bg-dark text-white">
            <h4 class="display-10" style="text-align:center;">On-time rentals</h4>
        </div>
<table style="vertical-align: middle;background-color:#E6E6FA;font-size:16px;text-align:center;" class="table table-striped">
    <thead>
        <tr>
...
<div class="card bg-dark text-white">
            <h4 class="display-10" style="text-align:center;">Late rentals</h4>
            </div>
<table style="vertical-align: middle;background-color:#E6E6FA;font-size:16px;text-align:center;" class="table table-striped">
    <thead>
        <tr>
...
<div class="card bg-dark text-white">
            <h4 class="display-10" style="text-align:center;">Accepted rentals</h4>
            </div>
<table style="vertical-align: middle;background-color:#E6E6FA;font-size:16px;text-align:center;" class="table table-striped">
    <thead>
        <tr>
...
<div class="card bg-dark text-white">
            <h4 class="display-10" style="text-align:center;">Rejected rentals</h4>
            </div>
<table style="vertical-align: middle;background-color:#E6E6FA;font-size:16px;text-align:center;" class="table table-striped">
    <thead>
        <tr>
